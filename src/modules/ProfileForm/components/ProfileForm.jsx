...
class ProfileForm extends React.PureComponent {
  ...
  render() {
    ...
    const prefixSelectorGithub = getFieldDecorator(
      "prefix",
      {}
    )(<div style={{ width: 42 }}>https://</div>);
    const prefixSelectorTelegram = getFieldDecorator(
      "prefix",
      {}
          ...
          {!success ? (
            ...
            >
              <Row>
                ...
                <Col span={11}>
                  <Form.Item label="Город" hasFeedback>
                    {getFieldDecorator("city", {
                      ...
                      <Input id="city" size="large" placeholder="Ваш город" />
                    )}
                  </Form.Item>
                </Col>
                <Col span={11} offset={2}>
                  <Form.Item label="Год рождения" hasFeedback>
                    {getFieldDecorator(
                      "monthPicker",
                      config
                    )(
                ...
                <Col span={11}>
                  <Form.Item label="Ссылка на проект" hasFeedback>
                ...
                <Col span={11} offset={2}>
                  <Form.Item label="Telegram" hasFeedback>
                ...
                <Col span={24}>
                  <Form.Item hasFeedback label="Дополнительно">
...
const WrappedProfileForm = Form.create({ name: "horizontal_login" })(
  ProfileForm
);
